...
set -g status-right "#[fg=#{@backg},bg=#{@backg},nobold,nounderscore,noitalics]#[fg=#82aaff,bg=#{@backg}]#[fg=#3b4261,bg=#{@backg},nobold,nounderscore,noitalics]#[fg=#82aaff,bg=#3b4261] #{speedtest_result} #[fg=white,bg=#{@accent},bold] #U#@#H#{?#{pane_ssh_port},:#{pane_ssh_port},} "
